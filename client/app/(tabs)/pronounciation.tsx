...
const API_BASE_URL = 'https://affe-2409-40e1-3094-f34b-e040-863f-eb38-7726.ngrok-free.app/api/pronounciation';
...
const handlePlayAudio = async () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Practice Suggestion Banner - Only show if no word is selected in pronunciation tab */}
